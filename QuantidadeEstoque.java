...
12) Make an algorithm to read: current quantity in stock, 
maximum quantity in stock and minimum quantity in stock of a product. 
Calculate and write the average quantity ((average quantity = maximum quantity + minimum quantity)/2). 
If the quantity in stock is greater than or equal to the average quantity, write the message 'Do not purchase', 
otherwise write the message 'Make purchase'.
 */
